...
> macOS arm64 binary: GitHub Actions artifact / rolling prerelease
> `grog-macos-aarch64` plus versioned `vX.Y.Z` releases (not official xAI
> `grok`; the Mac is download-only — `grog update`, do not compile grog there).
