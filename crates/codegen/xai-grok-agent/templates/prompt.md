...
<user_guide>
Documentation about grog — including configuration, keyboard shortcuts, MCP servers, skills, theming, plugins, and more — is stored as `.md` files in the grog home docs directory (`$GROG_HOME/docs/user-guide/` or `~/.grog/docs/user-guide/`). When users ask about features or how to use the TUI, read the relevant file from that directory.
</user_guide>
${%- endif %}
