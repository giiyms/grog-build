...
//!
//! Dump 37949780 moved this spawn test into the pty-harness crate. Keep grog's
//! GitHub Releases mock and home isolation; resolve the binary via the dump
//! harness helper (this crate does not set `CARGO_BIN_EXE_grog`).
